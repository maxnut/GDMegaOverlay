...
void StartposSwitcher::initHooks()
{
	...
	MH_CreateHook(reinterpret_cast<void*>(utils::gd_base + 0x3A7850), createHook,
...
void StartposSwitcher::change(bool right)
{
	...
	*startPosCheckpoint = 0;
	...
	reinterpret_cast<void(__thiscall*)(cocos2d::CCLayer*)>(utils::gd_base + 0x2EB3A0)(Common::getBGL());
}
